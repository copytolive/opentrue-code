...
contextBridge.exposeInMainWorld('rwacode', {
  ...
  files: {
    ...
    copyPath: (relativePath, kind) => ipcRenderer.invoke('fs:copyPath', relativePath, kind),
    openImagePreview: (relativePath) => ipcRenderer.invoke('fs:openImagePreview', relativePath),
    openTerminal: (relativePath) => ipcRenderer.invoke('fs:openTerminal', relativePath),
    clipboardSet: (relativePath, mode) => ipcRenderer.invoke('fs:clipboardSet', relativePath, mode),
    clipboardState: () => ipcRenderer.invoke('fs:clipboardState'),
    clipboardPaste: (destinationRelative) => ipcRenderer.invoke('fs:clipboardPaste', destinationRelative),
